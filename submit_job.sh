...
python run.py -c configs/imagenome_pretrain_config.yaml --train --random_seed 2
#python run.py -c configs/imagenome_pretrain_config.yaml --train --mask_mode clinical --mask_prob 0.5 --random_seed 2
